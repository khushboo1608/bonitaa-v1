...
<body>
	...
	<!--  Content start -->
	<?php include('content/register_details.php'); ?>
	<!--  Content End -->
    ...
    $.ajax({
     ...
     success: function(data)
     {
      ...
      if(data == 'mobile')
      {
        swal({
                title: "Sorry!",
                text: "Your number is already registered in our system",
                type: "warning",
        ...
        //alert('Your number is alrady exists..!')
      ...
      swal({
                title: "OTP Sent!",
                text: "An OTP has been sent to your phone, please enter OTP in next page to signup",
                type: "success",
