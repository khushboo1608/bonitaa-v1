...
<body>
    ...
    <?php include('content/my_profile_details.php'); ?>
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            if (data == 1) {
               swal({
                    title: "Success",
                    text: "Thanks, successfully Updated your profile.",
                    type: "success",
              ...
              //alert("Sucessfully added inquiry!");
            ...
            if(data == 5) {
                     swal({
                    title: "Error",
                    text: "This email id is already exists. please try other!",
                    type: "error",
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: true,
            ...
            if(data == 4) {
                     swal({
                    title: "Error",
                    text: "This mobile no is not already exists. please try other!",
                    type: "error",
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: true,
