...
<body>
  ...
  <!-- cart-box desgin   -->
   ...
   <?php include('content/edit_address_details.php'); ?> 
...
// alert('hii');
        ...
        $.ajax({
          type: "POST", 
          url: "public/edit_address.php",
          data: {address_id:address_id,address_type:address_type,address_name:address_name, address_number:address_number,address_houser_no:address_houser_no,address_lendmark:address_lendmark,state_id:state_id,city_id:city_id,lattitude:lattitude,postal_code:postal_code,longitude:longitude,address:address },
          success: function(res) {
            if(res == 0)
            {
                window.location ='#';
            }else if(res == 1){
                window.location ='select_address.php';
            }else if(res == 2){
                window.location ='#';
            }
          }
