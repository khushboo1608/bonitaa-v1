...
<body>
    ...
    <?php include('content/cart_details.php'); ?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#recommended_submit_checkout").on("click",function(e){
            e.preventDefault();
           
           //alert("Hello")
           
            var recommended = $("input[type='radio'].recommended:checked").val();
             
             //alert(recommended);
             
             if (!recommended) 
             {
                 window.location = "select_address.php?recommended=0";
             }else{
                 window.location = "select_address.php?recommended="+recommended;
             }
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".qty_plus").on("click",function(e){
        ...
        // alert(_quantity);
         $.ajax({
        url  : "public/add_cart_page_service_plus.php",
        type : "POST",
        cache: true,
        data : {cart_id:_id,quantity:quantity1},
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".qty_minus").on("click",function(e){
        ...
        //  alert(quantity1);
         $.ajax({
        url  : "public/add_cart_page_service_minus.php",
        type : "POST",
        cache: true,
        data : {cart_id:_id,quantity:quantity1},
        success:function(response){
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".cart_remove").on("click",function(e){
        ...
        //  alert(_quantity);
         $.ajax({
        url  : "public/add_cart_page_service_remove.php",
        type : "POST",
        cache: true,
        data : {cart_id:_id},
        success:function(response){
