...
// fully functional, in demo mode. Naryan create key as local & *B?D-*1**-4**M-*5**-*W**-Q*9*-2**B
$config['LicenseName'] = '';
$config['LicenseKey'] = '';
...
*/
// $baseUrl = 'https://www.acubeias.com/uploads/';
$baseUrl = ($_SERVER['HTTP_HOST']=="localhost") ? "http://localhost/personal/bonitaa.in/uploads/" : "https://www.bonitaa.in/web/uploads/";
