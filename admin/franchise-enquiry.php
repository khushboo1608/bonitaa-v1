<?php 
require('check.php');
$pageurl = "franchise-enquiry$extn";
$pagename = "Franchise Enquiry";
$tblname = "franchise_enquiry";
$id = @$_GET['id']; 
...
if(@$_GET['mode']=="delete" && $id !=""){
  ...
  if (!mysqli_query($con,$sql)){die('Error: ' . mysqli_error($con)); }
   echo"<META HTTP-EQUIV='REFRESH' CONTENT='0; URL=$pageurl?msgdanger=Enquiry%20Deleted%20successfully...'>";  exit(0);
}
          ...
          <table id="example1_samy" class="table table-bordered table-striped table-hover" style="text-align: center;">
            <thead>
              ...
              <tr>
                ...
                <th width="20">ID</th>
                <th width="90">Date</th>
                <th width="200">Enquiry Details</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left;">
                  <span class="bold">Name : <?php echo $row['name']; ?></span><br>
                  <i class="fa fa-envelope text-blue"></i> <span class="text-blue"><?php echo $row['email']; ?></span><br>
                  <i class="fa fa-phone text-red"></i><span class="text-red"> <?php echo $row['mobile']; ?></span><br>
                  <span class="bold"> Occupation : </span> <span><?php echo $row['occupation']; ?></span><br>
                  <span class="bold">Experience : </span> <span><?php echo $row['experience']; ?></span><br>
                </td>
                <td align="left">
                  <span class="bold">State/City:</span> <span><?php echo $row['location']; ?></span><br>
