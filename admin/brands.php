...
if((!empty($_FILES["image"])) && ($_FILES['image']['error'] == 0)){
  ...
  $newfilename = "brands-".date("ymdHis");
  //Determine the path to which we want to save this file
  $ext=".".$ext;
  $newname = '../uploads/brands/'.$newfilename.$ext;
...
if(@$_GET['mode']=="addnew"){
    ...
    $sql = "INSERT INTO `$tblname`(`status`, `image`) 
    VALUES ('1','$pic')";
            ...
            <?php } ?>
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  <label for="course_img"> <span class="text-red">Image (Size: 400x400px)</span> </label><br>
                  <span class="btn btn-primary margin">
                    <input type="file" name="image" id="image" class="img" style="width:250px;" <?= $img_required; ?>>
                  </span>
                </div>
                <?php if(@$_GET['mode']=="edit" && @$_GET['id']!="") { ?>
                <div class="form-group col-md-3">
                  <img src="<?= UPLOAD_PATH.'brands/'.$get_pic; ?>" width="100" height="100" alt="" style="border: 1px solid grey;padding: 2px; border-radius: 10px;">
                </div>
                <?php } ?>
              </div>
          ...
          <table id="example1_samy" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="center">
                  <img src="<?= UPLOAD_PATH.'brands/'.$cpic; ?>" width="50" height="50" style="border-radius:10%;">
                </td>
                <td>
