...
<body>
    ...
    <?php include('content/single_appointment_details.php'); ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".cancelOrder").on("click",function(e){
        ...
        var cancel_reason = $('#cancel_reason :selected').text();
        // alert(_id);
        //  alert(cancel_reason);
         $.ajax({
        url  : "public/add_cancel_reason_order.php",
        type : "POST",
        cache: true,
        data : {order_id:_id,cancel_reason:cancel_reason},
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".addRate").on("click",function(e){
        // alert('hii');
         e.preventDefault();
         var radio1 = $('[name="rating-star-button"]:checked').val();
         var radio2 = $('[name="rating-star-button-1"]:checked').val();
         var radio3 = $('[name="rating-star-button-3"]:checked').val();
         var _id=$(this).data("id");
        ...
        $.ajax({
        url  : "public/add_rating_order.php",
        type : "POST",
        cache: true,
        data : { radio1:radio1, radio2:radio2, radio3:radio3, id:_id, review:review },
        success:function(response){
          //alert(response);
          if (response == 1) {
            location.reload();
