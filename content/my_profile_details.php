...
$num_row = mysqli_num_rows($result_profile);
if($num_row ==1)
{
    if(!empty($row_profile['dp'])){
        $imageurl = UPLOAD_PATH.'users/'.$row_profile['dp'];
    }else{
        $imageurl ="";
    }
                                ...
                                <div class="form-container">
                                    ...
                                    <form id="submitForm" name="submitForm" method="post" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-control">
                                            <input required=""  name="user_name" id="user_name" value='<?php echo $row_profile['name'] ?>' type="text" placeholder="Enter Your Name" />
                                        </div>

                                        <div class="form-control">
                                            <input type="email" name="user_email" id="user_email" required="" value='<?php echo $row_profile['email'] ?>'  placeholder="Enter Your Email" />
                                        </div>
                                        ...
                                        <div class="">
                                          <select name="city_id" id="city_id" class="form-control form-control-lg" aria-label="Default select example" disabled>
                                              ...
                                              while ($row_state = mysqli_fetch_array($results_state)) {
                                                if ($row_state['name'] == $_SESSION['city_name']) {
                                                  ?>
